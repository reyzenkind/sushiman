...
{
	import com.pixelrebellen.sushiman.assets.LifeItemAsset;
	 ...
	 */
	public class LifeItemMovieClipBitmap extends Bitmap
	{
		public function LifeItemMovieClipBitmap(bitmapData : BitmapData = null, pixelSnapping : String = "auto", smoothing : Boolean = false)
        {
            bitmapData;
			super(FlxP.movieClipClass2BitmapSeq(LifeItemAsset).bitmapData, pixelSnapping, smoothing);
        }
    }
}
